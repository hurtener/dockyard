// Code generated — DO NOT EDIT. Vendored from @modelcontextprotocol/ext-apps.
//
// Source:          src/generated/schema.ts
// Upstream commit: 7d4434e991516d91286dded5bb10266cd6cddd02 (2026-06-01)
// Blob SHA:        43687374eb02667b0045d261bc10e08f4b539621
// Re-vendor:       refetch this path at a new pinned commit; never hand-edit.
//
// This is the machine-readable MCP Apps schema, the single source of truth for
// the bridge's ui/ wire types (RFC §7.3, §10; D-182). web/bridge runtime imports
// it type-only (erased — the App bundle stays Zod-free); the wire-conformance
// test imports it as values to .parse() the bridge's outbound wire.
//
// COMPANION SPEC: docs/specifications/mcp-apps-2026-01-26.mdx is the prose copy
// of the SAME spec revision (2026-01-26 / SEP-1865), pinned to upstream commit
// 298e884ec3f02daba085acdb02042d73bd00b355. The two pins (298e884e prose,
// 7d4434e schema) are the same revision at different upstream commits and are
// content-equivalent as of this wave; reconcile BOTH on any spec bump (see
// docs/specifications/README.md). The Go runtime conforms to the prose copy; the
// View conforms to this schema — keeping them in lockstep avoids server↔View drift.
/* eslint-disable */
